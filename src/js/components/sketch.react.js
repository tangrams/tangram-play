...
import { ColorWrap, Hue, Alpha, Checkboard } from 'react-color/lib/components/common'
import { Saturation } from 'react-color/lib/components/common'
import SketchFields from './sketch-fields.react'
import SketchPresetColors from './sketch-preset-colors.react'

export class SketchPicker extends React.Component {
    constructor (props) {
        super(props);
    }
...
export default ColorWrap(SketchPicker)
